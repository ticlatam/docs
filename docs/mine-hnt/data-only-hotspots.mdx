...
:::warning
Earning $HNT for data transfer is expected to be enabled at a later time as part of [Milestone 2] (/use-the-network/light-hotspots/#milestone-2). Please look for updates in #gateway-development channel. This guide is released for preparation only.
:::
